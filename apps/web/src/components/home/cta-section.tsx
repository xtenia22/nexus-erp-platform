        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900 p-8 md:p-12">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                {company.content.home.ctaPrimary}
              </Link>
              ...
              >
                {company.content.home.ctaSecondary}
              </Link>
            </div>
          </div>
        </div>
